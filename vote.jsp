	...
	<div id="page">
		<div id="header">
			...
			<div id="tagline" style="text-align: justify;">
				<div style="background-image: url('images/11.jpg');font-size: 20px";solid-transparent :50%>
					<h2 style="margin: 0px 0px 0px 315px;">Please register your
						vote below</h2>
					<div style="padding: 0px 0px 21px 0;"background-image: url('images/1.jpeg');">
						<center>
								...
								<table cellspacing=0 cellpadding="10">
									...
									<c:choose>
										...
										<c:when test="${(user.vote).equalsIgnoreCase('DotNet')}">
											...
											<tr>
												<td></td>
												<td align=left><input type="radio" name="vote" value="jsp" />Jsp</td>
											</tr>
											
											<td></td>
												<td align=left><input type="radio" name="vote" value="html" />HTML</td>
											</tr>
										</c:when>
